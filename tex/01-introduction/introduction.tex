\section{Introduction}
  ...
  In Section~2, we establish the necessity of a Born--Infeld--type structure from bounded
  flux propagation.
  Section~3 recalls the emergence of effective continuum operators from relational
  Laplacians.
  Section~4 discusses metric reconstruction from operator symbols.
  Sections~5 and~6 derive flat and Schwarzschild geometries as dynamically selected
  solutions.
  Section~7 analyzes horizon formation as operator saturation.
